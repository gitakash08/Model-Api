...
model = joblib.load('Data/forecasting_model.pkl')
...
def generate_future_data(num_transporters, month, year):
    sample_names = [
        'BABA BAIDYANATH ENTERPRISES', 'ADITYA ENTERPRISES', 'FOUJI ROADLINES',
        'USHA ENTERPRISES','UDAY SHANKAR PRASAD SINGH', 'MAA KANTI INDANE',
        'TARA ENTERPRISES', 'MAA KALI ROADWAYS', 'PRIYANKA SINGH', 'AJEET KUMAR', 
        'RAVI TRANSPORT AGENCY', 'MAA KALI ROADWAYS', 'MA TARA ROADWAYS', 'PRAVIN KUMAR SINGH',
        'NISHAN GAS SERVICE', 'ARSH ENTERPRISES', 'ARG TRANSPORT','SURYA LOGISTICS' ]
